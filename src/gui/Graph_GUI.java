...
//        System.out.println(t.size());
        ...
        g.connect(n1.getKey(), n4.getKey(),9);
        g.connect(n2.getKey(), n1.getKey(),1);
        g.connect(n2.getKey(), n4.getKey(),2);
        g.connect(n3.getKey(), n2.getKey(),1);
        g.connect(n3.getKey(), n4.getKey(),3);
        g.connect(n4.getKey(), n3.getKey(),10);

        g.connect(n5.getKey(), n6.getKey(),1);
        g.connect(n5.getKey(), n7.getKey(),2);
        g.connect(n5.getKey(), n8.getKey(),3);
        g.connect(n6.getKey(), n5.getKey(),1);
        g.connect(n6.getKey(), n8.getKey(),5);
        g.connect(n7.getKey(), n6.getKey(),6);
        g.connect(n7.getKey(), n8.getKey(),7);
        g.connect(n8.getKey(), n7.getKey(),9);

        g.connect(n1.getKey(),n9.getKey(),10);
        g.connect(n9.getKey(),n1.getKey(),1);
        g.connect(n5.getKey(),n9.getKey(),1);
        g.connect(n9.getKey(),n5.getKey(),1);
